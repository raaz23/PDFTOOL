...
const PremiumFeatures = () => {
  return (
    <div className="px-6 w-full min-h-[520px] bg-miniBlack flex flex-col md:flex-row items-center py-16 lg:py-20 text-white">
      <div className="md:max-w-2xl md:flex-1 md:mr-6 mb-4 md:mb-0 flex flex-col justify-center">
        ...
        <button type="button" className=" md:w-48 py-2 mt-6 mb-6 md:mb-0 bg-primaryColor text-white  text-medium text-title tracking-widest text-xl rounded-lg hover:bg-red-800 transition-all ">Premium</button>
      </div>
