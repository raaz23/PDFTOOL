...
const PremiumFeatures = () => {
  return (
    <div className="px-8 w-full min-h-[520px] bg-miniBlack flex flex-col md:flex-row items-center justify-center py-8 px-4 text-white">
      <div className="md:max-w-2xl md:flex-1 md:mr-6 text-center mb-4 md:mb-0">
        ...
        <button type="button" className="w-96 h-12 mt-12 bg-primaryColor text-white  text-medium text-title tracking-widest text-xl rounded-md hover:bg-red-800 transition-all ">Premium</button>
      </div>
